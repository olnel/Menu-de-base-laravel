...
class UpdateReparationVehiculeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'articles.*.details.*.article_changer_id' => 'nullable|exists:articles,id',
            'articles.*.details.*.article_id' => 'nullable|exists:articles,id',
        ];
    }

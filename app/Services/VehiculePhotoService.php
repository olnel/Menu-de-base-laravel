...
use App\Repositories\VehiculePhotoRepository;
use App\Services\Base\BaseImageService;
use Carbon\Carbon;

class VehiculePhotoService extends BaseImageService
{
    protected array $imageFields= [
        'main' => [
            ...
            'thumb_field' => null,
            'path_prefix' => 'img/vehicule',
            'name_prefix' => 'vehicule',
            'create_thumb' => false,
            'max_dimension' => 1920,
            'quality' => 80,
            'format' => 'webp',
    ...
    public function __construct(VehiculePhotoRepository $repository, ImageService $imageService)
    {

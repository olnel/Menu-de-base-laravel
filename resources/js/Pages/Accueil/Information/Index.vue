...
import CardInformation from "@/Pages/Accueil/Information/CardInformation.vue";
...
const formModal = ref()
const title = computed(() => `  Information`)
...
<template>
    <authenticated-layout :title="title" selected-menu="information">

        <CardInformation :initial-data="data.data[0]">

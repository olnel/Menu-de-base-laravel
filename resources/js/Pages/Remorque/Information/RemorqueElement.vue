...
if (form.element_remorques?.length) {
    form.element_remorques = form.element_remorques.map(el => ({
        ...el,
...
onMounted(() => form.element_remorques.forEach((el, i) => { if (el.is_pneu) fetchPneusForRow(i); }));

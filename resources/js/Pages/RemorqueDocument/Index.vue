...
const columns = [
    {key: "date_expiration", title: "Date", dataIndex: "date_expiration", width: 100},
    {key: "immatriculation", title: "Immatriculation", dataIndex: "immatriculation"},
...
<template>
    ...
    <AuthenticatedLayout :title="title" selected-menu="remorquedocument" >
        ...
        >
            ...
            <template #add>
                ...
                <ButtonIcon v-if="can('vehicule.store')" @click="addNewdocument" type="primary"

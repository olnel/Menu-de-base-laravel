<template>
    <a-card
        id="image-upload"
        class="!rounded-none overflow-hidden border border-dashed border-primary- hover:border-primary transition-all
                duration-300 ease-in-out transform hover:scale-[1.02] hover:shadow-md bg-gray-200"
        :class="{
    ...
    >
        ...
        <template #cover>
            <div class="relative p-2">
                ...
                <div class="relative flex justify-center h-48">
                    <a-avatar
                        :size="224"
        ...
        <template #actions>
            <div class="px-3 py-3 relative">
                <a-upload
                    ...
                    class="w-full"
                >
                    <a-tooltip placement="top" :title="image ? 'Changer l\'image' : 'Choisir une image'" class="absolute -top-2 right-3">
                        <a-button
                            type="primary"
                            size="middle"
                            shape="default"
